...
namespace DataStructures.Dictionaries
{
    ...
    {
#pragma warning disable CS0693 // Type parameter 'TValue' has the same name as the type parameter from outer type 'OpenScatterHashTable<TKey, TValue>'
#pragma warning disable CS0693 // Type parameter 'TKey' has the same name as the type parameter from outer type 'OpenScatterHashTable<TKey, TValue>'
        /// <summary>
        /// Hash Table Cell.
        /// </summary>
        private class HashTableEntry<TKey, TValue> where TKey : IComparable<TKey>
#pragma warning restore CS0693 // Type parameter 'TKey' has the same name as the type parameter from outer type 'OpenScatterHashTable<TKey, TValue>'
#pragma warning restore CS0693 // Type parameter 'TValue' has the same name as the type parameter from outer type 'OpenScatterHashTable<TKey, TValue>'
        {
...
#pragma warning disable CS0649 // Field 'OpenScatterHashTable<TKey, TValue>._size' is never assigned to, and will always have its default value 0
        /// <summary>
        /// INSTANCE VARIABLES
        /// </summary>
        private int _size;
#pragma warning restore CS0649 // Field 'OpenScatterHashTable<TKey, TValue>._size' is never assigned to, and will always have its default value 0
#pragma warning disable CS0169 // The field 'OpenScatterHashTable<TKey, TValue>._loadFactor' is never used
        private decimal _loadFactor;
#pragma warning restore CS0169 // The field 'OpenScatterHashTable<TKey, TValue>._loadFactor' is never used
