...
namespace DataStructures.Dictionaries
{
    ...
    public class ChainedHashTable<TKey, TValue> : IDictionary<TKey, TValue> where TKey : IComparable<TKey>
    {
        ...
        /// <summary>
        /// A high-level function that handles both contraction and expansion of the internal collection.
        /// </summary>
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            while (true)
            {
                ...
                if (i >= array.Length || hashTableIndex >= _hashTableStore.Length)
                    break;
                ...
                if (_hashTableStore[hashTableIndex] != null && _hashTableStore[hashTableIndex].Count > 0)
                {
                    ...
                    else
                    {
                        ...
                        while (i < array.Length && headOfChain != null)
                        {
