...
namespace DataStructures.Dictionaries
{
    ...
    {
#pragma warning disable CS0693 // Type parameter 'TKey' has the same name as the type parameter from outer type 'CuckooHashTable<TKey, TValue>'
#pragma warning disable CS0693 // Type parameter 'TValue' has the same name as the type parameter from outer type 'CuckooHashTable<TKey, TValue>'
        /// <summary>
        /// THE CUCKOO HASH TABLE ENTERY
        /// </summary>
        private class CHashEntry<TKey, TValue> where TKey : IComparable<TKey>
#pragma warning restore CS0693 // Type parameter 'TValue' has the same name as the type parameter from outer type 'CuckooHashTable<TKey, TValue>'
#pragma warning restore CS0693 // Type parameter 'TKey' has the same name as the type parameter from outer type 'CuckooHashTable<TKey, TValue>'
        {
