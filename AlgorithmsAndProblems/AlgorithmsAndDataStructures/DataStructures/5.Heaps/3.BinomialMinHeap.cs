...
namespace DataStructures.Heaps
{
    ...
    {
#pragma warning disable CS0693 // Type parameter 'T' has the same name as the type parameter from outer type 'BinomialMinHeap<T>'
        /// <summary>
        /// The Heap Node class.
        /// </summary>
        private class BinomialNode<T> where T : IComparable<T>
#pragma warning restore CS0693 // Type parameter 'T' has the same name as the type parameter from outer type 'BinomialMinHeap<T>'
        {
