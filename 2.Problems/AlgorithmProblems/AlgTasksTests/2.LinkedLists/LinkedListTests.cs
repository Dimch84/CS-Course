using AlgTasks.Helpers;
using AlgTasks.LinkedLists;
using NUnit.Framework;

namespace AlgTasksTests
{
    class LinkedListTests
    {
        ...
        public static void TestRemoveDuplicates()
        {
            ...
            Assert.IsTrue(list.IsSameListAs(new LinkedList<int>(new int[] { 5, 6 })), "check that duplicated are removed");
        ...
        public void TestGetKFromEnd()
        {
            ...
            Assert.IsNull(list.GetKFromEnd(6), "check when k > length");
        }
